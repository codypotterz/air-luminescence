...
int main(int argc, char** argv)
{
  ...
  auto detConstruction = new OpNoviceDetectorConstruction();
...
//  opticalParams->SetScintExcitationRatio(1.0);
...
//  opticalParams->SetScintFiniteRiseTime(true);
  ...
  physicsList->RegisterPhysics(radioactiveDecayPhysics);

  runManager->SetUserInitialization(physicsList);


  auto actionInitialization = new OpNoviceActionInitialization(detConstruction);
