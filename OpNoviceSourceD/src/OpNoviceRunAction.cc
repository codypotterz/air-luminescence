  ...
  , fPrimary(prim)
{
      ...
      analysisManager->CreateH1("Eabs", "Deposited energy of alphas in the absorber", 100, 0.2*MeV, 6*MeV, "MeV");
      analysisManager->CreateH1("Labs", "Track length of alphas in the absorber", 100, 2.*mm, 60*mm, "mm");
